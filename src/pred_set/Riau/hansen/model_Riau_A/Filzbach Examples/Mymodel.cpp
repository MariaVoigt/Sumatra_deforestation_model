...
void applyModel(int plookup)
{
	...
	for (j = 0; j < iterations; j++)
	{
		...
		for (n = 0; n < numsteps; n++)
		{
			...
			sprintf(fname, "E:/Sumatra_model_August22/hansen/Riau/model_Riau_A/preddef_i%d_%dyr.asc", j, n);
...
void read_data()
{
	...
	//EDIT
	readAsciiGrid("./workspace/forest_2017_21_180m_repro_res_hansen_Riau.ascii", forest);		//
	readAsciiGrid("./workspace/deforestation_2017_21_180m_repro_res_hansen_Riau.ascii", def);		//
	readAsciiGrid("./workspace/slope_180m_repro_res_hansen_Riau.ascii", slope);		//
	readAsciiGrid("./workspace/fire_yearly_average_180m_repro_res_hansen_Riau.ascii", fire);		//
	readAsciiGrid("./workspace/IDN_TTCSM_hrs_180m_repro_res_hansen_Riau.ascii", access_hrs);		//
	readAsciiGrid("./workspace/road_distance_180m_repro_res_hansen_Riau.ascii", roads);		//
	readAsciiGrid("./workspace/river_distance_180m_repro_res_hansen_Riau.ascii", rivers);		//
	readAsciiGrid("./workspace/pressurelog10_sigma1_180m_repro_res_hansen_Riau.ascii", pp_1);		//
	readAsciiGrid("./workspace/subsistence_LH_distance_180m_repro_res_hansen_Riau.ascii", subsistenceLH);		//
	...
	readAsciiGrid("./workspace/piaps_180m_repro_res_hansen_Riau.ascii", piaps);		//
	readAsciiGrid("./workspace/mining_180m_repro_res_hansen_Riau.ascii", mining);		//mining
	readAsciiGrid("./workspace/lu_new_class_180m_repro_res_hansen_Riau.ascii", landuse);		//landuse
	return;
