...
void read_data()
{
	...
	readAsciiGrid("./workspace/ind_plantations_distance_180m_repro_res_tmf_Riau.ascii", ind_plantations);		//
	readAsciiGrid("./workspace/soc_econMPI_180m_repro_res_tmf_Riau.ascii", mpi);		//
...
void setup_model()
{
	...
	parameter_create("beta_3", -2.0, 5.0, 0.0, 0, 0, 1);		//fire
