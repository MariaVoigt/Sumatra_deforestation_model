...
void read_data()
{
	...
	//EDIT
	readAsciiGrid("./workspace/forest_2017_21_180m_repro_res_tmf_W_Sumatra.ascii", forest);		//
	readAsciiGrid("./workspace/deforestation_2017_21_180m_repro_res_tmf_W_Sumatra.ascii", def);		//
	readAsciiGrid("./workspace/slope_180m_repro_res_tmf_W_Sumatra.ascii", slope);		//
	readAsciiGrid("./workspace/fire_yearly_average_180m_repro_res_tmf_W_Sumatra.ascii", fire);		//
	readAsciiGrid("./workspace/IDN_TTCSM_hrs_180m_repro_res_tmf_W_Sumatra.ascii", access_hrs);		//
	readAsciiGrid("./workspace/road_distance_180m_repro_res_tmf_W_Sumatra.ascii", roads);		//
	readAsciiGrid("./workspace/river_distance_180m_repro_res_tmf_W_Sumatra.ascii", rivers);		//
	readAsciiGrid("./workspace/pressurelog10_sigma1_180m_repro_res_tmf_W_Sumatra.ascii", pp_1);		//
	readAsciiGrid("./workspace/subsistence_LH_distance_180m_repro_res_tmf_W_Sumatra.ascii", subsistenceLH);		//
	readAsciiGrid("./workspace/non_agri_LH_distance_180m_repro_res_tmf_W_Sumatra.ascii", non_agriLH);		//
	readAsciiGrid("./workspace/transmigrant_distance_180m_repro_res_tmf_W_Sumatra.ascii", transmigrant);		//
	readAsciiGrid("./workspace/ind_plantations_distance_180m_repro_res_tmf_W_Sumatra.ascii", ind_plantations);		//
	readAsciiGrid("./workspace/soc_econMPI_180m_repro_res_tmf_W_Sumatra.ascii", mpi);		//

	readAsciiGrid("./workspace/peat_180m_repro_res_tmf_W_Sumatra.ascii", peat);		//peat
	readAsciiGrid("./workspace/piaps_180m_repro_res_tmf_W_Sumatra.ascii", piaps);		//
	readAsciiGrid("./workspace/mining_180m_repro_res_tmf_W_Sumatra.ascii", mining);		//mining
	readAsciiGrid("./workspace/lu_new_class_180m_repro_res_tmf_W_Sumatra.ascii", landuse);		//landuse
	return;
