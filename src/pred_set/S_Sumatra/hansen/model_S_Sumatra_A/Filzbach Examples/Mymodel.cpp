...
void applyModel(int plookup)
{
	...
	for (j = 0; j < iterations; j++)
	{
		...
		for (n = 0; n < numsteps; n++)
		{
			...
			sprintf(fname, "M:/Sumatra_model_August22/hansen/S_Sumatra/model_Bengkulu_A/preddef_i%d_%dyr.asc", j, n);
...
void read_data()
{
	...
	//EDIT
	readAsciiGrid("./workspace/forest_2017_21_180m_repro_res_hansen_S_Sumatra.ascii", forest);		//
	readAsciiGrid("./workspace/deforestation_2017_21_180m_repro_res_hansen_S_Sumatra.ascii", def);		//
	readAsciiGrid("./workspace/slope_180m_repro_res_hansen_S_Sumatra.ascii", slope);		//
	readAsciiGrid("./workspace/fire_yearly_average_180m_repro_res_hansen_S_Sumatra.ascii", fire);		//
	readAsciiGrid("./workspace/IDN_TTCSM_hrs_180m_repro_res_hansen_S_Sumatra.ascii", access_hrs);		//
	readAsciiGrid("./workspace/road_distance_180m_repro_res_hansen_S_Sumatra.ascii", roads);		//
	readAsciiGrid("./workspace/river_distance_180m_repro_res_hansen_S_Sumatra.ascii", rivers);		//
	readAsciiGrid("./workspace/pressurelog10_sigma1_180m_repro_res_hansen_S_Sumatra.ascii", pp_1);		//
	readAsciiGrid("./workspace/subsistence_LH_distance_180m_repro_res_hansen_S_Sumatra.ascii", subsistenceLH);		//
	readAsciiGrid("./workspace/plantation_LH_distance_180m_repro_res_hansen_S_Sumatra.ascii", plantationLH);		//
	readAsciiGrid("./workspace/non_agri_LH_distance_180m_repro_res_hansen_S_Sumatra.ascii", non_agriLH);		//
	readAsciiGrid("./workspace/transmigrant_distance_180m_repro_res_hansen_S_Sumatra.ascii", transmigrant);		//
	readAsciiGrid("./workspace/small_plantations_distance_180m_repro_res_hansen_S_Sumatra.ascii", small_plantations);		//
	readAsciiGrid("./workspace/soc_econMPI_180m_repro_res_hansen_S_Sumatra.ascii", mpi);		//

	readAsciiGrid("./workspace/peat_180m_repro_res_hansen_S_Sumatra.ascii", peat);		//peat
	readAsciiGrid("./workspace/piaps_180m_repro_res_hansen_S_Sumatra.ascii", piaps);		//
	readAsciiGrid("./workspace/mining_180m_repro_res_hansen_S_Sumatra.ascii", mining);		//mining
	readAsciiGrid("./workspace/lu_new_class_180m_repro_res_hansen_S_Sumatra.ascii", landuse);		//landuse
	return;
...
int main()
{
	...
	for (turn = 0; turn <= npara; turn++)
	{
		...
		for (tp = -1; tp < npara; tp++)
		{
			...
			else
			{
				...
				table_output("model_likelihood", "M:/Sumatra_model_August22/hansen/S_Sumatra/model_Bengkulu_A/TempLhoodDdef_1.txt");
	...
	//output likelihood table 
	table_output("model_likelihood", "M:/Sumatra_model_August22/hansen/S_Sumatra/model_Bengkulu_A/Models_Stepwise_1.txt");
