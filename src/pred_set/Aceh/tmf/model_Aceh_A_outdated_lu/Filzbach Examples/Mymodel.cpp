...
mybeta_8, mybeta_9, mybeta_10, mybeta_11,  gampeat[1], gampiaps[2], gamplant[2], gammine[2], gamlu[3],  myrho;
int beta0_global = 1;
...
void read_data()
{
	...
	readAsciiGrid("./workspace/lu_outdated_180m_repro_res_tmf_Aceh.ascii", landuse);		//landuse
	return;
...
void setup_model()
{
	...
	parameter_create_vector("gamma_lu", -6.0, 4.0, 0.0, 0, 0, 1, 3);// EDIT
