...
void applyModel(int plookup)
{
	...
	for (j = 0; j < iterations; j++)
	{
		...
		for (n = 0; n < numsteps; n++)
		{
			...
			sprintf(fname, "E:/Sumatra_model_August22/hansen/Aceh/model_Aceh_A/predprob_yr%d_i%d.asc", n, j);
			...
			sprintf(fname, "E:/Sumatra_model_August22/hansen/Aceh/model_Aceh_A/predfor_i%d_%dyr.asc", j, n);
			...
			sprintf(fname, "E:/Sumatra_model_August22/hansen/Aceh/model_Aceh_A/preddef_i%d_%dyr.asc", j, n);
...
void read_data()
{
	...
	//EDIT
	readAsciiGrid("./workspace/forest_2017_21_180m_repro_res_hansen_Aceh.ascii", forest);		//
	readAsciiGrid("./workspace/deforestation_2017_21_180m_repro_res_hansen_Aceh.ascii", def);		//
	readAsciiGrid("./workspace/slope_180m_repro_res_hansen_Aceh.ascii", slope);		//
	readAsciiGrid("./workspace/fire_yearly_average_180m_repro_res_hansen_Aceh.ascii", fire);		//
	readAsciiGrid("./workspace/IDN_TTCSM_hrs_180m_repro_res_hansen_Aceh.ascii", access_hrs);		//
	readAsciiGrid("./workspace/road_distance_180m_repro_res_hansen_Aceh.ascii", roads);		//
	readAsciiGrid("./workspace/river_distance_180m_repro_res_hansen_Aceh.ascii", rivers);		//
	readAsciiGrid("./workspace/pressurelog10_sigma1_180m_repro_res_hansen_Aceh.ascii", pp_1);		//
	readAsciiGrid("./workspace/subsistence_LH_distance_180m_repro_res_hansen_Aceh.ascii", subsistenceLH);		//
	readAsciiGrid("./workspace/plantation_LH_distance_180m_repro_res_hansen_Aceh.ascii", plantationLH);		//
	readAsciiGrid("./workspace/non_agri_LH_distance_180m_repro_res_hansen_Aceh.ascii", non_agriLH);		//
	readAsciiGrid("./workspace/transmigrant_distance_180m_repro_res_hansen_Aceh.ascii", transmigrant);		//
	readAsciiGrid("./workspace/small_plantations_distance_180m_repro_res_hansen_Aceh.ascii", small_plantations);		//
	readAsciiGrid("./workspace/soc_econMPI_180m_repro_res_hansen_Aceh.ascii", mpi);		//

	readAsciiGrid("./workspace/peat_180m_repro_res_hansen_Aceh.ascii", peat);		//peat
	readAsciiGrid("./workspace/piaps_180m_repro_res_hansen_Aceh.ascii", piaps);		//
	readAsciiGrid("./workspace/mining_180m_repro_res_hansen_Aceh.ascii", mining);		//mining
	readAsciiGrid("./workspace/lu_new_class_180m_repro_res_hansen_Aceh.ascii", landuse);		//landuse
	return;
