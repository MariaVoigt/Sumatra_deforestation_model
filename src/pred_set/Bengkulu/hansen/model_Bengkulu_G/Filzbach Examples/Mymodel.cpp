...
//Bengkulu
#define GRIDNX 1734
#define GRIDNY 1978 // dimensions of grid we are using
#define XLLCORNER -2554738.004000000190
#define YLLCORNER  1021869.379999999888// coerner dimensions
...
void read_data()
{
	...
	//EDIT
	readAsciiGrid("./workspace/forest_2017_21_180m_repro_res_hansen_Bengkulu.ascii", forest);		//
	readAsciiGrid("./workspace/deforestation_2017_21_180m_repro_res_hansen_Bengkulu.ascii", def);		//
	readAsciiGrid("./workspace/slope_180m_repro_res_hansen_Bengkulu.ascii", slope);		//
	readAsciiGrid("./workspace/fire_yearly_average_180m_repro_res_hansen_Bengkulu.ascii", fire);		//
	readAsciiGrid("./workspace/IDN_TTCSM_hrs_180m_repro_res_hansen_Bengkulu.ascii", access_hrs);		//
	readAsciiGrid("./workspace/road_distance_180m_repro_res_hansen_Bengkulu.ascii", roads);		//
	readAsciiGrid("./workspace/river_distance_180m_repro_res_hansen_Bengkulu.ascii", rivers);		//
	readAsciiGrid("./workspace/pressurelog10_sigma1_180m_repro_res_hansen_Bengkulu.ascii", pp_1);		//
	readAsciiGrid("./workspace/subsistence_LH_distance_180m_repro_res_hansen_Bengkulu.ascii", subsistenceLH);		//
	readAsciiGrid("./workspace/plantation_LH_distance_180m_repro_res_hansen_Bengkulu.ascii", plantationLH);		//
	readAsciiGrid("./workspace/non_agri_LH_distance_180m_repro_res_hansen_Bengkulu.ascii", non_agriLH);		//
	readAsciiGrid("./workspace/transmigrant_distance_180m_repro_res_hansen_Bengkulu.ascii", transmigrant);		//
	readAsciiGrid("./workspace/soc_econMPI_180m_repro_res_hansen_Bengkulu.ascii", mpi);		//

	readAsciiGrid("./workspace/peat_180m_repro_res_hansen_Bengkulu.ascii", peat);		//peat
	readAsciiGrid("./workspace/piaps_180m_repro_res_hansen_Bengkulu.ascii", piaps);		//
	readAsciiGrid("./workspace/mining_180m_repro_res_hansen_Bengkulu.ascii", mining);		//mining
	readAsciiGrid("./workspace/lu_new_class_180m_repro_res_hansen_Bengkulu.ascii", landuse);		//landuse
	return;
...
void setup_model()
{
	...
	parameter_create_vector("gamma_peat", -35.0, 2.0, 0.0, 0, 0, 1, 1);// // last digit is 1+ the last element in get_params, to allow a parameter value for each class (excluding zero!)
