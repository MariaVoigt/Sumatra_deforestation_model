...
void applyModel(int plookup)
{
	...
	for (j = 0; j < iterations; j++)
	{
		...
		for (n = 0; n < numsteps; n++)
		{
			...
			//sprintf(fname, "M:/Sumatra_model_August22/hansen/N_Sumatra/model_N_Sumatra_G/predprob_yr%d_i%d.asc", n, j);
			...
			//	sprintf(fname, "M:/Sumatra_model_August22/hansen/N_Sumatra/model_N_Sumatra_G/predfor_i%d_%dyr.asc", j, n);
			...
			sprintf(fname, "M:/Sumatra_model_August22/hansen/N_Sumatra/model_N_Sumatra_G/preddef_i%d_%dyr.asc", j, n);
...
void read_data()
{
	...
	//EDIT
	readAsciiGrid("./workspace/forest_2017_21_180m_repro_res_hansen_N_Sumatra.ascii", forest);		//
	readAsciiGrid("./workspace/deforestation_2017_21_180m_repro_res_hansen_N_Sumatra.ascii", def);		//
	readAsciiGrid("./workspace/slope_180m_repro_res_hansen_N_Sumatra.ascii", slope);		//
	readAsciiGrid("./workspace/fire_yearly_average_180m_repro_res_hansen_N_Sumatra.ascii", fire);		//
	readAsciiGrid("./workspace/IDN_TTCSM_hrs_180m_repro_res_hansen_N_Sumatra.ascii", access_hrs);		//
	readAsciiGrid("./workspace/road_distance_180m_repro_res_hansen_N_Sumatra.ascii", roads);		//
	readAsciiGrid("./workspace/river_distance_180m_repro_res_hansen_N_Sumatra.ascii", rivers);		//
	readAsciiGrid("./workspace/pressurelog10_sigma1_180m_repro_res_hansen_N_Sumatra.ascii", pp_1);		//
	readAsciiGrid("./workspace/subsistence_LH_distance_180m_repro_res_hansen_N_Sumatra.ascii", subsistenceLH);		//
	readAsciiGrid("./workspace/plantation_LH_distance_180m_repro_res_hansen_N_Sumatra.ascii", plantationLH);		//
	readAsciiGrid("./workspace/non_agri_LH_distance_180m_repro_res_hansen_N_Sumatra.ascii", non_agriLH);		//
	readAsciiGrid("./workspace/transmigrant_distance_180m_repro_res_hansen_N_Sumatra.ascii", transmigrant);		//
	readAsciiGrid("./workspace/soc_econMPI_180m_repro_res_hansen_N_Sumatra.ascii", mpi);		//

	readAsciiGrid("./workspace/peat_180m_repro_res_hansen_N_Sumatra.ascii", peat);		//peat
	readAsciiGrid("./workspace/piaps_180m_repro_res_hansen_N_Sumatra.ascii", piaps);		//
	readAsciiGrid("./workspace/mining_180m_repro_res_hansen_N_Sumatra.ascii", mining);		//mining
	readAsciiGrid("./workspace/lu_new_class_180m_repro_res_hansen_N_Sumatra.ascii", landuse);		//landuse
	return;
...
void setup_model()
{
	...
	parameter_create("beta_12", -2.0, 2.0, 0.0, 0, 0, 1);		//mpi

	parameter_create_vector("gamma_peat", -10.0, 10.0, 0.0, 0, 0, 1, 1);// // last digit is 1+ the last element in get_params, to allow a parameter value for each class (excluding zero!)
